...
namespace DeuceGear.UnitTests.EnumExtensions
{
    ...
    public partial class EnumExtensionsTestFixture
    {
        ...
        public void EnumExtensionsTextValueTestForUnknownValue()
        {
            ...
            Assert.That(((SafeEnum<ByteEnum>)((ByteEnum)15)).TextValue(), Is.EqualTo("15"));
            Assert.That(((SafeEnum<IntEnum>)((IntEnum)15)).TextValue(), Is.EqualTo("15"));
            Assert.That(((SafeEnum<LongEnum>)((LongEnum)15)).TextValue(), Is.EqualTo("15"));
            Assert.That(((SafeEnum<RegularEnum>)((RegularEnum)15)).TextValue(), Is.EqualTo("15"));
            Assert.That(((SafeEnum<ShortEnum>)((ShortEnum)15)).TextValue(), Is.EqualTo("15"));
